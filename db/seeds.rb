  ...
  users.each do |professional|
    disabled_type.each do |person|
      ...
      if disabled_type == childs
        ...
        school_agenda = disabled.agendas.create(
        ...
        school_agenda.boards.create(
          ...
          image: 'child_school_pictograms/colegio.png'
        )
      else
        ...
        adult_house_agenda.boards.create(
          name: 'Ver la tele',
          image: 'adult_house_pictograms/televión.png'
        )
      end
    end
  end
...
child_house_pictograms = ['abuelos', 'aburrido', 'baño', 'beber', 'calle',
  ...
  'ordenandor_1', 'papá', 'parque', 'primo', 'sí_1', 'triste_1', 'yo']
